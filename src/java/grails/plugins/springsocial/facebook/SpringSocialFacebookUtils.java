...
import grails.plugins.springsocial.config.FacebookReflectionUtils;
 ...
 * Helper methods.
 */
public final class SpringSocialFacebookUtils {

    private static ConfigObject config;

    private SpringSocialFacebookUtils() {
        // static only
    }
    ...
    public static void reloadConfig() {
        mergeConfig(FacebookReflectionUtils.getConfig(), "DefaultSpringSocialFacebookConfig");
    }
    ...
    private static void mergeConfig(final ConfigObject currentConfig, final String className) {
        GroovyClassLoader classLoader = new GroovyClassLoader(SpringSocialFacebookUtils.class.getClassLoader());
        ...
        FacebookReflectionUtils.setConfig(config);
    }
